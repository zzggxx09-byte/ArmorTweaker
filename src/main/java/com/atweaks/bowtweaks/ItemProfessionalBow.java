...
public class ItemProfessionalBow extends ItemBow {
    ...
    public void registerIcons(IIconRegister iconRegister) {
        this.itemIcon = IconHelper.register(iconRegister, "bowtweaks", "professional_bow_standby", "minecraft:bow_standby");

        pullIcons = new IIcon[3];
        pullIcons[0] = IconHelper.register(iconRegister, "bowtweaks", "professional_bow_pulling_0", "minecraft:bow_pulling_0");
        pullIcons[1] = IconHelper.register(iconRegister, "bowtweaks", "professional_bow_pulling_1", "minecraft:bow_pulling_1");
        pullIcons[2] = IconHelper.register(iconRegister, "bowtweaks", "professional_bow_pulling_2", "minecraft:bow_pulling_2");
    }
    ...
    public IIcon getIcon(ItemStack stack, int renderPass, EntityPlayer player, ItemStack usingItem, int useRemaining) {
        ...
        int drawTicks = ConfigHandler.proBowDrawTicks;
    ...
    public ItemStack onItemRightClick(ItemStack stack, World world, EntityPlayer player) {
        boolean hasAmmo = player.capabilities.isCreativeMode || player.inventory.hasItem(ModItems.itemArrowIron);
        ...
        if (hasAmmo) {
            ...
            world.playSoundAtEntity(player, "bowtweaks:professional_bow_draw", 0.5F, 1.0F);
        }
        return stack;
    }
    ...
    public void onPlayerStoppedUsing(ItemStack stack, World world, EntityPlayer player, int useRemaining) {
        ...
        world.playSoundAtEntity(player, "bowtweaks:professional_bow_shoot", 1.0F,
